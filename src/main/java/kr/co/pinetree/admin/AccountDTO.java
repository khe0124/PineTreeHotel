...
public class AccountDTO {
	...
	public String toString() {
		return "AccountDTO [ac_id=" + ac_id + ", ac_name_kor=" + ac_name_kor + ", ac_name_eng=" + ac_name_eng
				+ ", ac_passwd=" + ac_passwd + ", ac_phone=" + ac_phone + ", ac_email=" + ac_email + ", ac_grade="
				+ ac_grade + ", ac_stay=" + ac_stay + ", ac_date=" + ac_date + ", ac_logindate=" + ac_logindate + "]";
	}
