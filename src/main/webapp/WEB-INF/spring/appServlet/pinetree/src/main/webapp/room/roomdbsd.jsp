        ...
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            ...
	            <h1 class="mb-4 bread">Double Standard</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-12">
          	<div class="row">
          		...
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
    						...
    						<p>안락한 반원형 형태의 소파를 중심으로 영화를 감상할 수 있는 미디어 룸을 갖춘 패밀리 스위트는 가족 또는 지인들과 소중한 추억을 보내기 좋은 최적의 객실입니다.</p>
				</div>
				
          		<div class="col-md-12 room-single ftco-animate mb-5 mt-4">
          			<h3 class="mb-4">객실 내부</h3>
          			<div class="block-16">
		              <figure>
          				...
          				<div class="col-sm col-md-3 ftco-animate">
				    				<div class="room">
				    					...
				    					<div class="text p-3 text-center">
				    						<h3 class="mb-3"><a href="rooms.html">Family Suite</a></h3>
				    						<p><span class="price mr-2">500,000원</span> <span class="per">1박</span></p>
				    						<hr>
				    						<p class="pt-1"><a href="room-single.html" class="btn-custom">객실 상세보기 <span class="icon-long-arrow-right"></span></a></p>
				    					</div>
				    				</div>
				    	</div>
				    	<div class="col-sm col-md-3 ftco-animate">
				    				<div class="room">
				    					...
				    					<div class="text p-3 text-center">
				    						<h3 class="mb-3"><a href="rooms.html">Twin Suite</a></h3>
				    						<p><span class="price mr-2">400,000원</span> <span class="per">1박</span></p>
				    						<hr>
				    						<p class="pt-1"><a href="room-single.html" class="btn-custom">객실 상세보기 <span class="icon-long-arrow-right"></span></a></p>
				    					</div>
				    				</div>
