          ...
          <div class="col-md-12 d-flex">        	          	
            ...
            <form name="loginfrm" 
	            ...
	            <div class="form-group">              	
	                ...
	                <input type="text" name="ac_id" id="ac_id" placeholder="아이디를 입력하세요." required class="form-control" >
	             </div>
	             <div class="form-group">      	                
	                <label for="ac_passwd">비밀번호 </label>               	
	                <input type="text" name="ac_passwd" id="ac_passwd" size="30" placeholder="비밀번호를 입력하세요."
