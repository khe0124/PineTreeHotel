			...
			<div class="row">
				...
				<div class="col-lg-9">
					<div class="row">
						...
						<!-- 객실특징 -->
						<div class="container">
							<h3 align="center">Twin Suite 상세정보</h3>
							<div class="row">
								<div class="col-md-4">
									<div class="thumbnail">
						...
						<!-- 다른 예약가능한방 -->
						<div class="col-md-12 room-single ftco-animate mb-5 mt-5">
							<h4 class="mb-4">다른 예약가능한 방</h4>
							<div class="row">	
								<div class="col-sm col-md-4 ftco-animate">
									<div class="room">
										<a href="./doublestandard.do"
										...
										<div class="text p-4 text-center">
											...
											<hr>
											<p class="pt-1">
												<a href="./doublestandard.do" class="btn-custom">객실 상세보기 <span
								...
								<div class="col-sm col-md-4 ftco-animate">
									<div class="room">
										...
										<div class="text p-4 text-center">
											...
											<hr>
											<p class="pt-1">
												<a href="./doubledeluxe.do" class="btn-custom">객실 상세보기 <span
													class="icon-long-arrow-right"></span></a>
											</p>
										</div>
									</div>
							...
							<div class="fields">
								...
								<label for="room_name">객실 타입</label>
									<div class="select-wrap one-third">
										...
										<input type="text" class="form-control" value="트윈 스위트" readonly>
										<input type="hidden" name="room_name" id="room_name" class="form-control" value="SU" readonly>
