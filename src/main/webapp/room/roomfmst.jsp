		...
		<div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
			<div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
				<div class="text">
					...
					<h1 class="mb-4 bread">Family Suite</h1>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-lg-9">
					<div class="row">
						...
						<div class="col-md-12 ftco-animate">
							<h2 class="mb-4">패밀리스위트</h2>
							<div class="row">
								<div class="col-md-12">
									<figure>
										<img src="../images/room-1.jpg" width="825px">
									</figure>
								</div>
							</div>
						</div>
						...
						<!-- 객실특징 -->
						<div class="container">
							<h3 align="center">Familiy Suite 상세정보</h3>
							<div class="col=md-12">
							...
							<div class="fields">
								...
								<label for="room_name">객실 타입</label>
									<div class="select-wrap one-third">
										<input type="text" class="form-control" value="패밀리 스위트" readonly>
