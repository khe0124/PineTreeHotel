	...
	<div class="container">
		<div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
			<div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
				<div class="text">
					<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.do">Home</a></span> <span>Room</span></p>
			...
			<div class="row">
				...
				<div class="col-lg-9">
					<div class="row">
						...
						<!-- 객실특징 -->
						<div class="container">
							<h3 align="center">Double Standard 상세정보</h3>
							<div class="row">
								<div class="col-md-4">
									<div class="thumbnail">
							...
							<div class="fields">
								...
								<label for="room_name">객실 타입</label>
									<div class="select-wrap one-third">
										<input type="text" class="form-control" value="더블 스탠다드" readonly>
										<input type="hidden" name="room_name" id="room_name" class="form-control" value="ST" readonly>
