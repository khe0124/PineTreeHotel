		...
		<div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
			<div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
				<div class="text">
					...
					<h1 class="mb-4 bread">Double Suite</h1>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-9">
					<div class="row">
						...
						<!-- 객실특징 -->
						<div class="container">
							<h3 align="center">Double Suite 상세정보</h3>
							<div class="row">
								<div class="col-md-4">
									<div class="thumbnail">
								...
								<div class="col-sm col-md-4 ftco-animate">
									<div class="room">
										...
										<div class="text p-4 text-center">
											...
											<hr>
											<p class="pt-1">
												<a href="./familiysuite.do" class="btn-custom">객실 상세보기 <span
							...
							<div class="fields">
								...
								<label for="room_name">객실 타입</label>
									<div class="select-wrap one-third">
										<input type="text" class="form-control" value="더블 스위트" readonly>
