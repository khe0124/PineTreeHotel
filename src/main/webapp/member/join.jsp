		...
		<div class="container">
          ...
          <div class="col-md-12 d-flex">          	
          	<div class="bg-white p-5 join-form">
          		<div class="formDiv">
            <form method="post" action="./join.do" name="joinfrm" id="joinfrm" onsubmit="return joinCheck(this)">
            <h3 class="h4">약관동의</h3>
...
[부칙]
            ...
            <label for="agreement">
            <input type="checkbox" id="agreement" value="약관동의">
               	약관에 동의합니다.
            </label>
            </div>
            ...
            <div class="form-group">                      	
                ...
                <input type="text" name="ac_id" id="ac_id" class="form-control">                
            </div>
            <div class="form-group">
            ...
            <h3 class="h4">성명(한글)</h3>
              <div class="form-group">              	
                ...
                <input type="text" name="ac_name_kor" id="ac_name_kor" placeholder="예시 - 홍길동" class="form-control">
                </label>
              </div>
              <div class="form-group">
              ...
              <h3 class="h4">성명(영문)</h3>
               <div class="form-group">
                ...
                <input type="text" name="ac_name_eng" id="ac_name_eng" placeholder="예시 - JennyKim" class="form-control">
                </label>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">              	
                ...
                <input type="text" name="ac_phone" id="ac_phone" class="form-control" maxlength="11" placeholder="예시 - 01012341234">                               
              </div>
              <div class="form-group">              	
              	<label for="ac_email">이메일주소</label>            	
                <input type="text" name="ac_email" id="ac_email" class="form-control" placeholder="예시 - test01@gmail.com">                               
              </div>
