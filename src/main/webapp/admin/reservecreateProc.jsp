...
<div class="container-fluid">
	<h1 class="mt-4">신규 예약 생성</h1>
 	<!-- 본문시작 -->
	<form method="post" action="./reservecreateProc.do">
		<table class="table">
			<tr>
				<th>객실번호</th>
			...
			<tr>
				<th>체크인</th>
				<td><input type='date' size='20' name='cart_chin'/></td>
			</tr>
			<tr>
				<th>체크아웃</th>
				<td><input type='date' size='20' name='cart_chout'/></td>
			</tr> 
			<tr>
				<th>조식어른</th>
				<td><input type='number' min='0' max='2' name='cart_op_ad'/></td>
			</tr>
			<tr>
				<th>조식아이</th>
				<td><input type='number' min='0' max='2' name='cart_op_bb'/></td>
			</tr>
			<tr>
				<th>객실수</th>
				<td><input type='number' min='0' max='3' name='cart_oprm'/></td>
			</tr>
			<tr>
				<th>어른수</th>
				<td><input type='number' min='0' max='2' name='cart_adno'/></td>
			</tr>
			<tr>
				<th>아이수</th>
				<td><input type='number' min='0' max='2' name='cart_bbno'/></td>
			</tr>
			<tr>
				<th>침대수</th>
				<td><input type='number' min='0' max='2' name='cart_op_bed'/></td>
			</tr>
		</table>

		<div class='bottom'>
			<input type='submit' value='예약등록' class="btn"> 
