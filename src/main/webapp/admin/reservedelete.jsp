...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">예약 삭제</h1>
		<!-- 본문시작 -->
		<form method="post" action="./reservedelete.do">
			<input type="hidden" name="ol_num" value=${dto.ol_num } >
			<br><p style="text-align: center">예약을 삭제하시겠습니까?</p><br>
		
			<div class='bottom' align="center">
				<input type='submit' value='예약삭제' class="btn"> 
				<input type='button' value='예약목록' class="btn">
			</div>
		</form>
		<!-- 본문끝 -->
      </div>
