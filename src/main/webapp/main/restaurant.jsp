			...
			<div class="container">
	          ...
	          <div class="heading-section heading-section-wo-line pt-md-4 mb-5">
	          	<div class="ml-md-0">
		            ...
		            <h2 class="mb-4">Reverie</h2>
	            </div>
	          </div>
	          <div class="pb-md-4">
							<p>미쉐린 1스타 레스토랑 Reverie는 지금껏 경험해보지 못했던 창의적인 프랑스 요리를 선보입니다. 메트로폴리탄과 넓은 태평양 바다가 한눈에 들어오는 환상적인 전망을 바라보며 미쉐린 3스타 셰프 '프레드릭 오송'이 선사하는 잊지 못할 다이닝을 경험해 보시기 바랍니다.</p>
						</div>
					</div>
				</div>
			</div>
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>이탈리안 리조또</span></h3>
	        				<span class="price">45,000원</span>
	        			</div>
	        			<div class="d-block">
	        				<p>정통 이탈리아 레시피를 따르는 고품격 리조또</p>
	        			</div>
        			</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>그릴에 구운 장어덮밥</span></h3>
	        				<span class="price">35,000원</span>
	        			</div>
	        			<div class="d-block">
	        				<p>신선한 장어와 쯔유로 만든 특제 간장 소스로 만든 장어덮밥</p>
	        			</div>
	        		</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>오가닉 베지 샐러드</span></h3>
	        				<span class="price">32,000원</span>
	        			</div>
	        			<div class="d-block">
	        				<p>호텔 직영 오가닉 농장에서 재배한 채소들로 만든 샐러드</p>
	        			</div>
	        		</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>큐브 오므라이스</span></h3>
	        				<span class="price">32,000원</span>
	        			</div>
	        			<div class="d-block">
	        				<p>정통 이탈리안 스타일 오므라이스</p>
	        			</div>
	        		</div>
        		</div>
        	</div>
        	...
        	<div class="col-md-6">
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>발렌타인 스트로베리 케이크</span></h3>
	        				<span class="price">29,000원</span>
	        			</div>
	        			<div class="d-block">
	        				<p>사랑을 담아 만든 스트로베리 초콜릿 케이크</p>
	        			</div>
	        		</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>프룻 샐러드</span></h3>
	        				<span class="price">30,000원</span>
	        			</div>
	        			<div class="d-block">
	        				<p>신선한 제철과일로 플레이팅 된 샐러드</p>
	        			</div>
	        		</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>더치 커피</span></h3>
	        				<span class="price">9,000원</span>
	        			</div>
	        			<div class="d-block">
	        				<p>최고급 아라비카 원두를 사용한 더치 커피</p>
	        			</div>
	        		</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>라임레몬 모히토</span></h3>
	        				<span class="price">15,000원</span>
	        			</div>
	        			<div class="d-block">
	        				<p>상큼한 라임과 레몬의 절묘한 조합</p>
	        			</div>
	        		</div>
        		</div>
        	</div>
