        ...
        <div class="row">
        	<div class="col-md-5 p-md-5 img img-2 img-3 d-flex justify-content-center align-items-center">
					...
					<c:if test="${s_mlevel == '6'}">
					   ...
					   <input type="submit" class="btn btn-primary" value="수정" onclick="Location.href='noticeUpdate.do?nt_num=${dto.nt_num}'">
					   <input type="reset" class="btn btn-danger" value="삭제" onclick="Location.href='noticeDelete.do?nt_num=${dto.nt_num}'">
					   </div>
				    </c:if> 
