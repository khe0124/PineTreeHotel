...
<section class="ftco-section">
	<div class="container">
		<div class="row d-flex">
			<form method="post" action="./promoUpdate.do"
				enctype="multipart/form-data">
				<input type="hidden" name="pm_num" value="${dto.pm_num }">
				<table align='center' border='1px' cellspacing='0px'
					cellpadding='5px'>
					<tr>
						<th>제목</th>
						<td><input type='text' name='pm_title' size="30"
							maxlength="100" class="form_input" value='${dto.pm_title }'></td>
					</tr>
					<tr>
						<th>내용</th>

						<td><textarea rows="5" cols="35" name="pm_cont">${dto.pm_cont }</textarea></td>
